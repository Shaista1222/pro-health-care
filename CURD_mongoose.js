...
const runApp = async()=> {
    try {
        ...
        //will del many doscuments according to name as well
        ...
        //based on or condition delete many
...
// new ObjectId(), you are creating a new instance of this identifier type
//to rename the collection
//db.record.renameCollection("record")
//replaceOne()
